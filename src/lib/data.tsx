...
export const EXPERIENCES: ExperienceDetails[] = [
  {
    ...
    position: 'Head of Backend Development Section',
    startDate: new Date(2026, 4),
    currentlyWorkHere: true,
    summary: [
      'Promoted from Backend Developer; set technical direction for backend development across multiple services and business modules.',
      'Work across dozens of services in a microservices environment (Go, NestJS) backed by PostgreSQL, Redis, and RabbitMQ.',
      'Consolidated two real-time game services (Socket.IO and native socket) into a single architecture built on native WebSocket.',
      'Built Go-based background processing for large, non-real-time datasets spanning multiple services, run as scheduled jobs.',
      'Design and maintain REST and gRPC APIs, asynchronous workflows, and real-time services.',
      'Work with engineering, business, and management stakeholders to translate business processes into backend solutions.',
    ],
  },
  {
    logo: LogoGanesha,
    ...
    summary: [
      'Developed backend services in Go and NestJS within a microservices architecture, integrating services over REST and gRPC.',
      'Delivered backend modules for leave management, student management and progress reporting, marketing and sales data, payments, and other operational processes.',
      'Contributed to API design, database integration, and architecture decisions; investigated and resolved issues across development and production environments.',
    ],
  },
  {
    logo: LogoCDI,
    darkModeLogo: LogoCDI,
    logoAlt: 'Castellum Digital Indonesia Logo',
    position: 'Frontend Developer (Freelance)',
    startDate: new Date(2024, 8),
    endDate: new Date(2024, 9),
    summary: [
      'Built a responsive React.js dashboard for the SATUSEHAT program.',
      'Cut page load time by 40% and raised user engagement by 25%.',
    ],
  },
  {
    logo: LogoRefactory,
    ...
    summary: [
      'Built middleware services and APIs in .NET to integrate enterprise procurement systems (BSI KTB), and backend APIs in Go for high-performance web applications such as the Tempo news portal.',
      'Contributed to the design and integration of microservices-based enterprise systems (procurement, finance, vendor management) using Clean Architecture.',
      'Developed Vue.js and Razor interfaces, a Flutter mobile app (BLoC), and automated tests with Robot Framework.',
    ],
  },
];
